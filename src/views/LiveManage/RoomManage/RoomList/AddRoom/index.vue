<template>
  <div>
    <el-card>
      ...
      <div>
        <el-form ref="addRoomFormRef" :model="addRoomForm" label-position="left" label-width="100px">
          <el-row :gutter="10">
            <el-col :span="12">
              ...
              <el-form-item label="直播间标题" class="form_item">
                <el-input v-model="addRoomForm.Name" placeholder="填写本次直播的标题" maxlength="17" show-word-limit></el-input>
              </el-form-item>
              <el-form-item label="开播时间" class="form_item">
                <el-date-picker v-model="roomDate" type="datetimerange" range-separator="至" start-placeholder="开始日期"
                  end-placeholder="结束日期" value-format="yyyy-MM-dd HH:mm:ss" @change="getTime">
                </el-date-picker>
              </el-form-item>
              ...
              <el-form-item label="主播微信账号" class="form_item">
                <el-input v-model="addRoomForm.AnchorWechat" placeholder="请输入主播微信账号"></el-input>
              </el-form-item>
              <el-form-item label="主播副号" class="form_item">
                <el-input v-model="addRoomForm.SubAnchorWechat" placeholder="请输入主播微信账号"></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
                ...
                <div class="live_form_box">
                  ...
                  <el-form-item label-width="0">
                    <el-upload class="upload-demo"
                      action="https://dataexpansion.cn/api/business/BroadcastRoom/UploadMedia" list-type="picture"
                      :multiple="false" :limit="1">
                      <el-button size="small" type="primary">点击上传</el-button>
                    </el-upload>
                  </el-form-item>
              ...
              <div class="live_cover_bg_box">
                ...
                <div class="live_cover_info_box">
                  ...
                  <el-form-item label-width="0" style="margin-left:15px;">
                    <el-checkbox true-label="1" false-label="0" v-model="addRoomForm.CloseComment" checked>评论
                    </el-checkbox>
                  </el-form-item>
                  <el-form-item label-width="0" style="margin-left:15px;">
