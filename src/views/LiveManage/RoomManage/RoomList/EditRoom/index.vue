<template>
                  ...
                  <div class="live_form_box">
                    ...
                    <el-form-item label-width="0" prop="ShareImg">
                      ...
                      <el-upload
                        ...
                        action="action"
                        list-type="picture"
                        :http-request="uploadLiveShareImg"
                        :multiple="false"
                        :limit="1"
                        :on-preview="handlePreview"
                        :on-remove="handleShareRemove"
                        :on-change="handleShareChange"
                      >
                  ...
                  <div class="live_form_box">
                    ...
                    <el-form-item label-width="0" prop="FeedsImg">
                      ...
                      <el-upload
                        ...
                        action="action"
                        list-type="picture"
                        :http-request="uploadLiveImg"
                        :multiple="false"
                        :limit="1"
                        :on-preview="handlePreview"
                        :on-remove="handleFeedsRemove"
                  ...
                  <div class="live_cover_info_box">
                    ...
                    <el-form-item label-width="0" prop="CoverImg" style="margin-left: 15px">
                      ...
                      <el-upload
                        ...
                        action="action"
                        list-type="picture"
                        :http-request="uploadLiveCoverImg"
                        :multiple="false"
                        :limit="1"
                        :on-preview="handlePreview"
                        :on-remove="handleCoverRemove"
                        :on-change="handleLiveCoverChange"
                      >
                        <el-button size="small" type="primary"
                          >点击上传</el-button
                        >
  ...
  import { getRoomDetail, editRomm } from '@/api/liveManage/roomEdit/roomEdit'
  export default {
    data() {
