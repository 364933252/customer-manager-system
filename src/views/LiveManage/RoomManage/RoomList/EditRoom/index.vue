  ...
  <div>
    <el-card>
      <div slot="header" style="text-align: center">
        <span style="font-weight: bold; font-size: 30px; text-align: center">查看/修改直播间</span>
      </div>
      <div>
        <el-form ref="editRoomFormRef" :model="editRoomForm" label-position="left" label-width="110px"
          ...
          <el-row :gutter="10">
            <el-col :span="12">
              ...
              <el-form-item label="直播间标题" class="form_item" prop="Name">
                <el-input v-model="editRoomForm.Name" placeholder="填写本次直播的标题" maxlength="17" show-word-limit clearable>
                </el-input>
              </el-form-item>
              <el-form-item label="开播时间" required>
                <el-col :span="8">
                  <el-form-item prop="StartTime">
                    <el-date-picker v-model="editRoomForm.StartTime" type="datetime" placeholder="选择开播时间"
                ...
                <el-col :span="11">
                  <el-form-item prop="EndTime">
                    <el-date-picker v-model="editRoomForm.EndTime" type="datetime" placeholder="选择结束时间"
                      value-format="yyyy-MM-dd HH:mm:ss">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
              ...
              <el-form-item label="主播昵称" prop="AnchorName" class="form_item">
                <el-input v-model="editRoomForm.AnchorName" placeholder="填写本次直播的主播昵称" maxlength="15" show-word-limit
                  clearable>
                </el-input>
              </el-form-item>
              <el-form-item label="主播微信账号" prop="AnchorWechat" class="form_item">
                <el-input v-model="editRoomForm.AnchorWechat" placeholder="请输入主播微信账号" clearable></el-input>
              </el-form-item>
              <el-form-item label="主播副号" class="form_item" prop="SubAnchorWechat">
                <el-row>
                  <el-col :span="20">
                    <el-input v-model="editRoomForm.SubAnchorWechat" placeholder="请输入主播副号微信账号" clearable></el-input>
                  </el-col>
                  <el-col :span="4">
                    <el-button type="text" @click="editSubAnchorWechat">修改主播副号</el-button>
                  </el-col>
                </el-row>
              </el-form-item>
                ...
                <div class="live_share_box">
                  ...
                  <div class="live_share">
                    ...
                    <div class="live_share_img">
                      <img src="../../../../../assets/images/share.png" class="share_img" alt="" srcset="" />
                    </div>
                  </div>
                </div>
              ...
              <div class="live_cover_bg_box">
                ...
                <div class="live_cover_info_box">
                  ...
                  <el-form-item label-width="0" style="margin-left: 15px">
                    <el-checkbox true-label="0" false-label="1" v-model="editRoomForm.CloseComment">评论
                    </el-checkbox>
                  </el-form-item>
                  <el-form-item label-width="0" style="margin-left: 15px">
                    <el-checkbox true-label="0" false-label="1" v-model="editRoomForm.CloseLike">点赞</el-checkbox>
                  </el-form-item>
                  <div class="cover_info_box">
                    <div class="info_title">拓展功能</div>
                  </div>
                  <el-form-item label-width="0" style="margin-left: 15px">
                    <el-checkbox true-label="0" false-label="1" v-model="editRoomForm.CloseKf">客服</el-checkbox>
                  </el-form-item>
                </div>
              </div>
            </el-col>
...
import { getRoomDetail, editRomm, editSubAnchorWechat } from '@/api/liveManage/roomEdit/roomEdit'
import { async } from 'q';
export default {
  data() {
    ...
    return {
      ...
      editRoomFormRules: {
        ...
        ShareImg: [
          { required: true, validate: ShareImgValidate, tigger: 'change' }
        ],
        FeedsImg: [
          { required: true, validate: FeedsImgValidate, tigger: 'change' }
        ],
        CoverImg: [
          { required: true, validate: CoverImgValidate, tigger: 'change' }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    // 修改主播副号
    editSubAnchorWechat: async function () {
      const confirmResult = await this.$confirm('此操作将修改主播副号, 是否继续?', '提示', {
      ...
      const params = {
        Entry: {
          roomId: this.roomId,
          username: this.editRoomForm.SubAnchorWechat
        }
      }
      const { data: res } = await editSubAnchorWechat(params)
      this.getRoomDetail(this.roomId)
      console.log(res, '修改主播副号');
    },
    // 修改直播间
